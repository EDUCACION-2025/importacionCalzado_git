...
if ($sheet->getHighestRow()<=24) {
	...
	for ($row = 2; $row <= $highestRow; $row++){ 
		...
		if ($sheet->getCell("A".$row)->getValue()=="" || $sheet->getCell("B".$row)->getValue()=="" || $sheet->getCell("C".$row)->getValue()=="" || $sheet->getCell("D".$row)->getValue()=="" || $sheet->getCell("E".$row)->getValue()=="" || $sheet->getCell("F".$row)->getValue()=="" || $sheet->getCell("G".$row)->getValue()=="" || $sheet->getCell("H".$row)->getValue()=="" || $sheet->getCell("I".$row)->getValue()=="" || $sheet->getCell("J".$row)->getValue()=="" || $sheet->getCell("K".$row)->getValue()=="" || $sheet->getCell("L".$row)->getValue()=="") {
	   ...
	   $queryDeportes="SELECT id_disciplina FROM ic_disciplina WHERE nombreDisciplina='$valorDeportes' AND estado='A';";	
