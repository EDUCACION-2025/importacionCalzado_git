            ...
            success: function(response){
                ...
                /*=====  End of Arreglos  ======*/
                  ...
                  var variableDeportiva=0;
                   ...
                   $(".body__tabla__productos").append('<tr style="padding:.5em;" class="filas__anadidas"><td colspan="13" style="padding:3em;" ><center><button class="guardar__productos__excel" id="guardarExelProductos" style="padding:2em;" name="guardarExelProductos">GUARDAR</button><div class="reload__cargar2"></div></center></td></tr>');
