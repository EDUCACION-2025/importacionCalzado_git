...
<div class="wrapper row3">
    ...
    <div class="contenedor__principal__de__formularios">
  		...
  		<div class="contenedor__principal">
  			...
  			<table id="tablaDocumentosUsuariosNegados" name="tablaDocumentosUsuariosNegados">
				<thead>
				   	<tr>
				   		<th>FECHA DE NEGACIÓN</th>
				     	<th>RUC</th>
			            <th>RAZÓN SOCIAL</th>
				     	<th>E-MAIL</th>
						<th>Revisar</th>
...
<div id="edicionUsuarioDocuNegados" class="modal" role="dialog" tabindex="-1" aria-labelledby="myModalLabel">
  	...
  	<div class="modal-dialog modal-lg">
	    ...
	    <div class="modal-content">
	      ...
	      <div class="modal-header" style="background: #cc473b; color: white">
	        ...
	        <h4 class="modal-title">INFORMACIÓN IMPORTADOR Y MOTIVO DE NEGACIÓN</h4>
	      </div>
        		...
        		<table class="table table-bordered">
		         ...
		         <label style="color: #cc473b">MOTIVO DE NEGACIÓN</label>
			     	...
			     	<table style="border: hidden;">
		          	<tr>
		          		<td style="width: 25%">
		          			<label style="color: #cc473b">PERSONA QUIEN NEGÓ</label>
		          		</td>
		          		<td>
