    ...
    <div class="contenedor__principal__de__formularios">
      ...
      <div class="contenedor__principal">
        ...
        <div style="width: 95%;">
            ...
            <table id="tablaCatalogoNegados" name="tablaCatalogoNegados">
...
<div id="edicionCatalogoNegados" class="modal" role="dialog" tabindex="-1" aria-labelledby="myModalLabel">
  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content"  style="width: 120%">
        ...
        <div class="modal-header" style="background: #fff59a; color: white">
          <button type="button" class="close" data-dismiss="modal" data-toggle='modal' data-target='#edicionCatalogoNegados '>&times;</button>
